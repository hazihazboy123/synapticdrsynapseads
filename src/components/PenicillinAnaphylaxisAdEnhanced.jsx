...
import { PenicillinAnaphylaxisMechanismEnhanced } from './diagrams/PenicillinAnaphylaxisMechanismEnhanced';

const timestampsData = require('../../public/assets/audio/penicillin-anaphylaxis-timestamps.json');

/**
 * PenicillinAnaphylaxisAdEnhanced - 10X BETTER VERSION
 *
 * IMPROVEMENTS:
 * ✅ Uses enhanced mechanism diagram with ParticleFlow components
 * ✅ Fixed overlapping - proper spacing for mobile viewing
 * ✅ Bigger components - optimized for TikTok/Instagram 9:16 ratio
 * ✅ Better visual hierarchy - nothing overlaps
 * ✅ 90% less particle code - using reusable components
 * ✅ Cleaner, more maintainable code
 */
export const PenicillinAnaphylaxisAdEnhanced = () => {
  ...
  // ===== KEY TIMESTAMPS =====
  const questionStartTimeRaw = 32.94;
  const answerRevealTimeRaw = 51.52;
  const teachingStartTime = 65.7;
  ...
  const vignetteStartTimestamp = 1.3;
  const clinicalFindingsTimestamp = 8.1;
  ...
  const getHighlightedOption = () => {
    ...
    if (doubleTakeFrames < 16) return 'D';
    return 'D';
  };
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#0a0a0a' }}>
      ...
      <BrainMascot
        ...
        shockMoment={Math.floor((23.08 / PLAYBACK_RATE) * fps)}
        thinkingPeriod={{
      ...
      {/* ===== ENHANCED MECHANISM DIAGRAM ===== */}
      <PenicillinAnaphylaxisMechanismEnhanced
          ...
          >
            <svg width="130" height="130" style={{ transform: 'rotate(-90deg)' }}>
              ...
              <circle
                ...
                r="52"
                fill="none"
                stroke="url(#timerGradientPenicillinEnhanced)"
                strokeWidth="10"
              ...
              />
              <defs>
                <linearGradient id="timerGradientPenicillinEnhanced" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default PenicillinAnaphylaxisAdEnhanced;
